@extends('layouts.app')
@section('content')
    <link rel="stylesheet" href="{{ asset('css/user/dormitory.css') }}">
                ...
                <div class="w-100 py-3 mt-3">
                        <div class="row">
                            ...
                            <div class="col-md-4 search mb-3 offset-md-2">
                                <form action="{{ url('/searchDormitory') }}" method="post" id="formSearch">
                                    @csrf
                                    <div class="row">
    ...
    <script src="{{ asset('js/user/dormitory.js') }}" defer></script>
@endsection