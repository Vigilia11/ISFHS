        ...
        <div class="row d-flex align-items-center justify-content-center h-100">
            <div class="col-md-9 bg-white shadow-sm py-2">
                ...
                <form method="post" action="{{ route('register') }}" enctype="multipart/form-data">
                    @csrf
                    <!--carousel-->
                    <div id="studentRegistrationForm" class="carousel carousel-dark slide position-relative m-3" style="height:500px">
                        <div class="carousel-indicators">
                            <button type="button" data-bs-target="#studentRegistrationForm" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                            <button type="button" data-bs-target="#studentRegistrationForm" data-bs-slide-to="1" aria-label="Slide 2"></button>
                            <button type="button" data-bs-target="#studentRegistrationForm" data-bs-slide-to="2" aria-label="Slide 3"></button>
                        </div>   
                        <div class="position-absolute bottom-0 end-0">
                            <button class="btn btn-sm bg-black text-white" type="button" data-bs-target="#studentRegistrationForm" data-bs-slide="prev">Prev</button>
                            <button class="btn btn-sm bg-black text-white" type="button" data-bs-target="#studentRegistrationForm" data-bs-slide="next">Next</button>
                        </div>
