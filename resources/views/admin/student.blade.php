    ...
    @foreach($user as $student)
        <div class="row justify-content-center">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 d-flex justify-content-center align-items-center">
                        <div class="profile-picture">
                            <img src="{{ asset('images/user/'.$student->profile_picture) }}" class="w-100 h-100" alt="">
                        </div>
                    </div>
                </div>
                <div class="mb-1 text-secondary account-status-display">
                    <input type="text" name="hidden_user_id" value="{{ $student->user_id }}" id="hidden_user_id">
                    <input type="text" name="hidden_account_id" id="hidden_account_id" value="{{ $student->account_id }}">
            ...
            <div class="col-md-9 bg-white shadow mb-5 p-3 " style="boder:1px solid #e5e7eb">
                <div class="row g-3">
                    <img src="{{ asset('images/id/'.$student->front_id) }}" alt="" class="col-md-6" style="height:400px">
                    <img src="{{ asset('images/id/'.$student->back_id) }}" alt="" class="col-md-6" style="height:400px">
                </div>
            </div>
        </div>
        @endforeach    
